...
$('#memberIds').select2({
  ...
  $("#leaderId").change(function(e) {
    ...
    if(leader_id != null) {
        ...
        return_combobox_multi_group('#memberIds',`/api/ticket/get-members?id=${array_id}`, '');
...
function loaddata(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            var validator = $("#form-add-group").validate(); // reset form
            validator.resetForm();
            return_combobox_multi_group($("#memberIds"), "/api/ticket/get-user-availble", "");
            return_combobox_multi_group($("#leaderId"), "/api/ticket/get-user-availble", "");
            $(".error").removeClass("error"); // loại bỏ validate
