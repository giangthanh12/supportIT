...
<body class="vertical-layout vertical-menu-modern content-left-sidebar navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar">
    ...
    <!-- BEGIN: Header-->
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl header-ticket" style="width:100%; left:50%; transform:translateX(-50%);">
    ...
    <!-- BEGIN: Content-->
    <div class="app-content content todo-application" style="margin-left:0px;">
    ...
    <style>
            ...
            @media only screen and (min-width: 767.99px) and (max-width: 1487.99px){
                .header-ticket {
                    width: 96% !important;
                }
            }
