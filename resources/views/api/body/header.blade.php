    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder"></span></div><span
                        class="avatar avatar-header"><img
                            onerror="this.src='{{ asset('app-assets/images/avatars/avatar.png') }}'"
                            style="object-fit: cover;" class="round" src="" alt="avatar" height="40"
