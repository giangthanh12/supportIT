                    ...
                    <div class="col-lg-6 col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between pb-0">
                                {{-- <h4 class="card-title">Hỗ trợ yêu cầu</h4> --}}
                            </div>
                            <div class="card-body statistic-ticket-user">
                                ...
                                <div class="d-flex justify-content-between mt-1 mb-1">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="{{route("api.assign-ticket")}}?status=2" href="" class="badge bg-warning font-large-1 fw-bold total_tickets_notdone" title="yêu cầu"></a>
                                    </div>
                                    <div class="text-center">
                                        <p class="card-text mb-50 fw-bold">Đã xử lý</p>
                                        <a href="{{route("api.assign-ticket")}}?status=5" class="badge bg-success  font-large-1 fw-bold total_tickets_done" title="yêu cầu"></a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 col-12 d-flex flex-column flex-wrap ">
                                ...
                                <div class="d-flex justify-content-between mt-1">
                                    ...
                                    <div class="text-center">
                                        <p class="card-text mb-50 fw-bold">Đang xử lý</p>
                                        <a href="{{route("api.my-ticket")}}?status=2" class="badge bg-warning font-large-1 fw-bold total_tickets_notdone_user" title="yêu cầu"></a>
                                    </div>
                                    <div class="text-center">
                                        <p class="card-text mb-50 fw-bold">Đã xử lý</p>
                                        <a href="{{route("api.my-ticket")}}?status=5" class="badge bg-success font-large-1 fw-bold total_tickets_done_user" title="yêu cầu"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-sm-center align-items-start flex-sm-row flex-column">
                                ...
                                <div class="header-right d-flex align-items-center mt-sm-0 mt-1">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end filter-group" aria-labelledby="dropdownItem4">
                                        @forelse ($groups as $group)
                                        <a class="dropdown-item" data-group_id="{{$group->id}}" href="#">{{$group->group_name}}</a>
                                        @empty
                                        @endforelse
                                    </div>
                                </div>
