                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/my-ticket">Trang chủ</a>
                                    </li>
                            ...
                            <div class="card-body overflow-auto" id="list-comments"  style="height: 400px;">
                                ...
                                <div class="comment mb-3">
                                    ...
                                    <div class="small d-flex justify-content-start">
                                          <a href="#!" class="d-flex align-items-center me-3 like-comment {{$comment->checkUserLike(Auth::id()) ? "active" : "" }}" data-comment_id = "{{$comment->id}}" >
                                          ...
                                          <a href="#!" class="d-flex align-items-center me-3 edit-comment" data-comment_id = "{{$comment->id}}">
                                ...
                                <div class="background-comment">
                                    <img style="width:100%" src="{{asset("app-assets/images/banner/background_comment.png")}}" alt="">
                                </div>
                                @endforelse
                                ...
                                <form class="form-validate" id="form-comment-ticket">
                                    ...
                                    <div class="d-flex flex-start w-100">
                                        <img class="rounded-circle shadow-1-strong me-3" style="object-fit: cover;"
                                            src="{{auth()->user()->avatar}}" onerror="this.src='{{asset('app-assets/images/avatars/avatar.png')}}'" alt="avatar"
                                            width="40" height="40" />
                                    ...
                                    <div class="float-end mt-2 pt-1">
                                        <button type="submit" class="btn btn-primary btn-sm" id="btn_add_comment">Bình luận</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab-fill" data-bs-toggle="tab" href="#home-fill" role="tab" aria-controls="home-fill" aria-selected="true">Chi tiết yêu cầu</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab-fill" data-bs-toggle="tab" href="#profile-fill" role="tab" aria-controls="profile-fill" aria-selected="false">Lịch sử hoạt động</a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                        ...
                                        <form class="form-validate" enctype="multipart/form-data" id="form-modal-ticket">
                                            ...
                                            <div class="row mt-1">
                                                ...
                                                <div class="col-md-6 form-group mb-1">
                                                    ...
                                                    <select class="select2 form-select" required id="ticket-status" disabled name="ticket-status">
                                                ...
                                                <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                                    <button type="submit"  class="btn btn-primary mb-1 mb-sm-0 mr-1 mr-sm-1 d-none" style="margin-right: 8px;" id="btnUpdate">Cập nhật</button>
                                                    {{-- <button onclick="handleDeleleTicket({{$ticket->id}})" type="button" id="btnDelete" class="btn btn-danger waves-effect waves-float waves-light d-none" style="margin-right: 8px;">Xóa</button> --}}
                                                    <button onclick="handleSuccess({{$ticket->id}})" type="button" id="btnSuccess" class="btn btn-outline-success  waves-effect waves-float waves-light d-none" style="margin-right: 8px;"><i class="fa fa-check" style="padding-right: 5px;"></i>Duyệt</button>
...
<script>
    ...
    var avatarAuth = "<?php echo auth()->user()->avatar; ?>";
    var nameAuth = "<?php echo auth()->user()->name; ?>";
