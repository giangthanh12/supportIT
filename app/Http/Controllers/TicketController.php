...
class TicketController extends Controller
{
    ...
    public function update(TicketRequest $request, $id) {
        ...
        return $this->successResponse($ticket,"Cập nhập yêu cầu thành công",200);
    }
   ...
   public function confirm_ticket(Request $request) {
    ...
    public function save_shortcut(ShortcutRequest $request) {
        ...
        $ticket = Ticket::create([
            ...
            "deadline"=>$request->input("ticket-deadline_shortcut"),
            "cc"=>$request->input("cc_shortcut"),
            "email_creator"=>$request->email_creator_shortcut,
            "group_id"=>$request->group_id_shortcut,
            "file"=>$file_path,
            "assignees_id"=>$request->input("task-assigned_shortcut"),
